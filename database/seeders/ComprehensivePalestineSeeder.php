...
class ComprehensivePalestineSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($timelineEvents as $event) {
            TimelineEvent::firstOrCreate(['slug' => $event['slug']], $event);
        }

        // 5. Gallery Items
        $galleryItems = [
            [
                'title' => 'Panoramic View of Old City Jerusalem and Dome of the Rock',
                'category' => 'Architecture',
                'media_type' => 'image',
                'media_url' => 'https://images.unsplash.com/photo-1547981609-4b6bf67db7ff?w=1000',
                'caption' => 'Golden dome of Al-Aqsa compound glowing in the evening sunlight over historic limestone buildings.',
                'year' => 2023,
                'views' => 1250,
            ],
            [
                'title' => 'Intricate Tatreez Cross-Stitch Patterns on Traditional Thobe',
                'category' => 'Culture',
                'media_type' => 'image',
                'media_url' => 'https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?w=1000',
                'caption' => 'Detailed view of hand-woven embroidery motifs representing village flora and traditional heritage.',
                'year' => 2022,
                'views' => 840,
            ],
            [
                'title' => 'Ancient Olive Trees in the Hills of Ramallah',
                'category' => 'Daily Life',
                'media_type' => 'image',
                'media_url' => 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=1000',
                'caption' => 'Centuries-old olive tree orchards symbolizing resilience and agricultural tradition.',
                'year' => 2023,
                'views' => 910,
            ],
            [
                'title' => 'Historic Mediterranean Waterfront of Jaffa Port',
                'category' => 'Historical Photos',
                'media_type' => 'image',
                'media_url' => 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=1000',
                'caption' => 'The ancient stone docks and sea gate of historic Jaffa, renowned for maritime commerce.',
                'year' => 2021,
                'views' => 670,
            ],
            [
                'title' => 'Archival Map & Manuscript Documents of 19th Century Palestine',
                'category' => 'Documents',
                'media_type' => 'image',
                'media_url' => 'https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?w=1000',
                'caption' => 'Original land registry and geographical surveys preserved in international library collections.',
                'year' => 1890,
                'views' => 540,
            ],
            [
                'title' => 'Traditional Palestinian Knafeh Baking in Nablus',
                'category' => 'Culture',
                'media_type' => 'image',
                'media_url' => 'https://images.unsplash.com/photo-1548625361-1859c25f49d8?w=1000',
                'caption' => 'Artisan pastry makers crafting iconic Nabulsi cheese knafeh in giant copper trays.',
                'year' => 2023,
                'views' => 1100,
            ]
        ];
